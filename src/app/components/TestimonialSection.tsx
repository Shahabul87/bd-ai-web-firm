    ...
    <section className="py-16 relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <TestimonialCard 
            quote="CodeGenius transformed our outdated website into a modern, high-converting digital asset in just two weeks. The AI-generated design exceeded our expectations."
          ...
          />
          <TestimonialCard 
            quote="We needed an e-commerce solution fast, and CodeGenius delivered in record time. The AI optimization has significantly boosted our sales performance."
